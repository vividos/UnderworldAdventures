...
# ADD LINK32 kernel32.lib user32.lib zlib.lib sdl.lib toolslib.lib /nologo /subsystem:console /machine:I386 /out:"../output/release/cnvdbg.exe" /libpath:"../output/release/toolslib"
...
# ADD LINK32 kernel32.lib user32.lib zlib.lib sdl.lib toolslib.lib /nologo /subsystem:console /debug /machine:I386 /nodefaultlib:"msvcrt" /out:"../output/debug/cnvdbg.exe" /pdbtype:sept /libpath:"../output/debug/toolslib"
