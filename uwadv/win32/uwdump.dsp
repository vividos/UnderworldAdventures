...
# ADD LINK32 sdl.lib toolslib.lib /nologo /subsystem:console /machine:I386 /out:"../output/release/uwdump.exe" /libpath:"../output/release/toolslib"
...
# ADD LINK32 sdl.lib toolslib.lib /nologo /subsystem:console /debug /machine:I386 /out:"../output/debug/uwdump.exe" /pdbtype:sept /libpath:"../output/debug/toolslib"
