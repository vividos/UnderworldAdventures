...
# ADD CPP /nologo /MD /W3 /GX /Zi /O2 /I "..\..\source" /I "..\..\source\base" /I "..\..\source\conv" /I "..\..\source\import" /I "..\..\source\underw" /D "NDEBUG" /D "_CONSOLE" /D "WIN32" /D "_MBCS" /D "_STLP_NO_IOSTREAMS" /YX /FD /c
...
# ADD LINK32 base.lib conv.lib import.lib script.lib underw.lib SDL.lib SDLmain.lib zlib.lib /nologo /subsystem:console /pdb:"Release\uastudio.pdb" /debug /machine:I386 /out:"Release\uastudio.exe" /libpath:"$(OutDir)\..\base" /libpath:"$(OutDir)\..\conv" /libpath:"$(OutDir)\..\import" /libpath:"$(OutDir)\..\script" /libpath:"$(OutDir)\..\underw"
...
# ADD CPP /nologo /MDd /W3 /Gm /Gi /GX /ZI /Od /I "..\..\source" /I "..\..\source\base" /I "..\..\source\conv" /I "..\..\source\import" /I "..\..\source\underw" /D "_CONSOLE" /D "_DEBUG" /D "HAVE_DEBUG" /D "WIN32" /D "_MBCS" /D "_STLP_NO_IOSTREAMS" /YX /FD /GZ /c
...
# ADD LINK32 base.lib conv.lib import.lib script.lib underw.lib SDL.lib SDLmain.lib zlib.lib /nologo /subsystem:console /pdb:"Debug\uastudio.pdb" /debug /machine:I386 /nodefaultlib:"msvcrt.lib" /out:"Debug\uastudio.exe" /pdbtype:sept /libpath:"$(OutDir)\..\base" /libpath:"$(OutDir)\..\conv" /libpath:"$(OutDir)\..\import" /libpath:"$(OutDir)\..\script" /libpath:"$(OutDir)\..\underw"
# SUBTRACT LINK32 /pdb:none
