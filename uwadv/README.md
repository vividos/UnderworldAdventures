...
----------------
  ...
  README.Linux.txt
     Informations for Linux (and similar operating systems) users to compile
...
--------------
  ...
  ua-doxygen.cfg
     Doxygen configuration file to build source documentation
