...
player_attr_attack = 8
player_attr_defense = 9

player_attr_life = 10
player_attr_max_life = 11
player_attr_mana = 12
player_attr_max_mana = 13

player_attr_weariness = 14
player_attr_hungriness = 15
player_attr_poisoned = 16
...
player_skill_axe = 2
player_skill_mace = 3
player_skill_missile = 4
player_skill_lore = 5
player_skill_casting = 6
player_skill_traps = 7
player_skill_search = 8
player_skill_track = 9
player_skill_sneak = 10
player_skill_repair = 11
player_skill_charm = 12
player_skill_picklock = 13
player_skill_acrobat = 14
player_skill_appraise = 15
player_skill_swimming = 16
