...
should go into c:\mingw\include\SDL\ (for our example).
...
folder. If you don't want to use STLport, edit these two lines that they look
as this:
...
(and "FMOD_INCLUDE", FMOD"_LIB", if you want FMOD MIDI support).
...
run. To build the tools, type:

   make -f Makefile.mingw tools

More infos about how to run Underworld Adventures can be found in the file
README.uwadv.txt.
