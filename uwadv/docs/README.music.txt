...
The contents of the zip file has to be extracted in the "uadata" folder
of Underworld Adventures. Please look into the installed config file
"uwadv.cfg" where this folder is located.

On the DOS command line or Linux shell, change into the "uadata" folder
and unzip the whole zip file, preserving the folder structure. When using
...
Note: not all pieces done are included in the digital soundtrack package.
