...
namespace Detail
{
   ...
   protected:
      ...
      bool SearchKeyFromString(const std::string& keyTypeName, EKeyType& key);

      /// sets key type and value in map
      void SetKeyValue(EKeyType& key, const std::string& keyValue);
   ...
   bool KeymapConfigLoader::SearchKeyFromString(const std::string& keyTypeName, EKeyType& key)
   {
      key = Base::keyNone;
   ...
   void KeymapConfigLoader::SetKeyValue(EKeyType& keyType, const std::string& keyValue)
   {
