...
# ADD LINK32 kernel32.lib user32.lib /nologo /subsystem:console /machine:I386 /out:"../../output/release/strpak.exe"
...
# ADD LINK32 kernel32.lib user32.lib /nologo /subsystem:console /debug /machine:I386 /out:"../../output/debug/strpak.exe" /pdbtype:sept
