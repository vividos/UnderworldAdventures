...
public:
   ...
   /// initializes button
   void init(ua_save_game_screen* screen, IGame& game,
...
protected:
   ...
   Base::SavegamesManager* savegames_manager;
...
public:
   /// ctor
   ua_save_game_screen(IGame& game, bool from_menu,
      bool disable_save);
   /// dtor
...
protected:
   ...
   /// appearance images
   std::vector<IndexedImage> img_faces;
