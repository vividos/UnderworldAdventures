...
void ua_start_splash_screen::init()
{
   ...
   game.get_audio_manager().StartMusicTrack(Audio::musicUw1_Introduction, false);
   ...
   if (!game.get_settings().GetBool(Base::settingUw1IsUwdemo) &&
      game.get_savegames_manager().GetSavegamesCount() > 0)
   {
...
bool ua_start_splash_screen::process_event(SDL_Event& event)
{
   ...
   case SDL_MOUSEBUTTONDOWN:
      ...
      case 3: // showing animation
         ...
         if (game.get_settings().GetBool(Base::settingUw1IsUwdemo))
            game.get_audio_manager().FadeoutMusic(blend_time);
...
void ua_start_splash_screen::tick()
{
   ...
   if ((stage == 1 || (stage == 0 &&
      game.get_settings().GetBool(Base::settingUw1IsUwdemo))) &&
   ...
   case 5:
      ...
      if (game.get_settings().GetBool(Base::settingUw1IsUwdemo))
      {
         ...
         Import::LoadUnderworld(game.get_settings(), game.GetResourceManager(), game.GetUnderworld());
