...
protected:
   ...
   /// compass images
   std::vector<IndexedImage> img_compass;
};
...
protected:
   /// all runestones
   std::vector<IndexedImage> img_runestones;
};
...
protected:
   /// all runestones
   std::vector<IndexedImage> img_spells;
};
...
protected:
   ...
   /// flask images
   std::vector<IndexedImage> img_flask;
};
...
protected:
   /// eyes images
   std::vector<IndexedImage> img_eyes;
};
...
protected:
   ...
   /// compass images
   std::vector<IndexedImage> img_dragon;
};
...
protected:
   ...
   std::unique_ptr<ua_player_physics_object> m_playerPhysics;
};
...
protected:
   ...
   /// powergame images
   std::vector<IndexedImage> img_powergem;
};
...
protected:
   ...
   /// action buttons
   std::vector<IndexedImage> img_actions;
