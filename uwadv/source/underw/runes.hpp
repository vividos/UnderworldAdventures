...
namespace Underworld
{
   ...
   public:
      ...
      ERuneType GetRune(unsigned int shelfIndex) const
      {
   ...
   private:
      /// runeshelf contents
      std::vector<ERuneType> m_runeshelf;
   };
   ...
   public:
      ...
      void SetRune(ERuneType rune, bool isAvail) { m_runebag.set(static_cast<size_t>(rune), isAvail); }
